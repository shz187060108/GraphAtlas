...
try {
    ...
    Invoke-Logged "figures" @("-u", "scripts\build_paper_figures.py", "--results", "outputs\results\latest.csv", "--output-dir", "outputs\reports\paper_figures", "--target-model", "graphatlas_c") "figures"
