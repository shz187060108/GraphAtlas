...
| --- | --- | --- | --- | --- |
| synthetic_significant_gain | False | {'passing_datasets': [], 'comparisons': [{'dataset': 'atlas_het_coordinate', 'baseline': 'ambient_vector_gnn', 'n_pairs': 0, 'mean_delta': nan, 'paired_t_p': nan, 'wilcoxon_p': nan, 'wilcoxon_holm_p': nan, 'passed': False}, {'dataset': 'atlas_het_coordinate', 'baseline': 'geometry_moe', 'n_pairs': 0, 'mean_delta': nan, 'paired_t_p': nan, 'wilcoxon_p': nan, 'wilcoxon_holm_p': nan, 'passed': False}]} | at least two Atlas-Het v2 datasets beat Ambient and GeometryMoE with paired significance |  |
