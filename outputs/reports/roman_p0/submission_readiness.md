...
| four_real_datasets | False | {'datasets': 1, 'mean_rank': nan, 'wins': {'graphatlas_no_metric': 0, 'graphatlas_no_cocycle': 0}} | four real datasets, mean rank <= 2.0, and majority wins over both regularizer ablations |  |
